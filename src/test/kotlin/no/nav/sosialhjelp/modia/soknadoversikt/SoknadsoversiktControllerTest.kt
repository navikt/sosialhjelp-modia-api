...
internal class SoknadsoversiktControllerTest {
    ...
    private val controller =
        SoknadsoversiktController(fiksClient, eventService, oppgaveService, dokumentasjonkravService, tilgangskontrollService)
    ...
    suspend fun `getSoknadDetaljer - skal mappe fra DigisosSak til SoknadDetaljerResponse`() {
        ...
        val response1 = controller.getSoknadDetaljer(id1, "token", Ident(fnr))
        ...
        val response2 = controller.getSoknadDetaljer(id2, "token", Ident(fnr))
        ...
        val response3 = controller.getSoknadDetaljer(id3, "token", Ident(fnr))
    ...
    suspend fun `getSoknadDetaljer - hvis model ikke har noen oppgaver, skal ikke oppgaveService kalles`() {
        ...
        val response = controller.getSoknadDetaljer(id1, "token", Ident(fnr))
