...
open class MaskinportenClientFss(
    ...
    override fun getToken(): String = getTokenFraCache() ?: getTokenFraMaskinporten()

    private fun getTokenFraCache(): String? = cachedToken?.takeUnless { isExpired(it) }?.parsedString
